...
import {
  Heart, LayoutDashboard, Mail, Users, Palette,
  MessageSquare, Gift, Settings, Crown, ShieldAlert,
} from 'lucide-react'
...
const SIDEBAR_ITEMS = [
  ...
  { icon: MessageSquare, label: 'Pesan & Buku Tamu', href: '/dashboard/pesan' },
  ...
  return (
    ...
    >
      ...
      <nav style={{ flex: 1, padding: '16px 12px' }}>
        ...
        {/* Admin link — only show if user email contains admin or plan is special */}
        <Link
          ...
          style={{
            display: 'flex', alignItems: 'center', gap: 12,
            padding: '10px 14px', borderRadius: 8,
            textDecoration: 'none', marginBottom: 4, marginTop: 8,
